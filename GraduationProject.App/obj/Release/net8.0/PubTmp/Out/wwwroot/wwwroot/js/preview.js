...
let raiseHandContent = document.getElementById("raiseHandContent");
let btnScreenShare = document.getElementById("btnScreenShare");
let videoScreenShare = document.getElementById("videoScreenShare");
let raiseHandButton = document.getElementById("raiseHandButton");
...
function addDomEvents() {
  ...
  $("#raiseHandButton").click(function () {
    ...
    {
      raiseHandContent.innerHTML = "You Have Raised Your Hand";
    }
    else
    {
      raiseHandContent.innerHTML = `<b>${remoteParticipantId}</b> Have Raised Their Hand`;
    }

    $("#raiseHandContent").show();
    setTimeout(function ()
    {
      $("#raiseHandContent").hide();
    }
    , 2000);
  });
...
async function toggleWebCam() {
  console.log("preivewVideoStream", preivewVideoStream);
  if (preivewVideoStream) {
    previewCamera.style.backgroundColor = "#1C1C1C";
    previewCamera.srcObject = null;
